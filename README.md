...
| Version | **0.2.4** · [v0.2.4](https://github.com/VirtualMachinist/geode/releases/tag/v0.2.4) · [CHANGELOG](CHANGELOG.md) |
| Rust | 1.85 |
...
Workspace **0.2.4** matches git tag [`v0.2.4`](https://github.com/VirtualMachinist/geode/releases/tag/v0.2.4) and the crates.io versions of `geode-grotto` / `geode-cli`. GDE1 objects from 0.2.0 remain readable; the format is frozen at suite `0x01`.
